...
resource "azurerm_private_dns_zone_virtual_network_link" "postgres" {
  name                  = "link-postgres-vnet-myapi-prd"
  resource_group_name   = module.environment.resource_group_name
...
module "vnet" {
  ...
  vnet_name                     = "vnet-myapi-prd"
  resource_group_name           = module.environment.resource_group_name
  location                      = module.environment.location
  address_space                 = var.vnet_address_space
  aca_subnet_cidr               = "10.2.0.0/23"
  postgres_subnet_cidr          = "10.2.4.0/24"
  private_endpoints_subnet_cidr = "10.2.5.0/24"
  runner_subnet_cidr            = "10.2.6.0/27"
  tags                          = var.tags
}
...
module "runner" {
  ...
  environment         = "prd"
  runner_labels       = "self-hosted,azure,prd"
  tags                = var.tags
}
